...
def evaluation_agent(state: Dict[str, Any]) -> Dict[str, Any]:
    ...
    for i, entry in enumerate(history, 1):
        ...
        answer = entry["answer"]
        system_prompt = ("""
            You are a **very strict** senior technical interviewer with 15+ years of experience.
            You evaluate answers **harshly and realistically** — most real candidates do NOT deserve 8+
            Strict scoring rubric — follow it religiously:

            9.5 - 10.0 : Truly outstanding. Deep insight, production experience, handles edge cases, innovative approach. Extremely rare.

            8.0 - 9.0   : Strong professional level. Minor polish needed. Only for clearly above-average answers.

            6.0 - 7.9   : Solid but average. Noticeable gaps or simplifications. This is the realistic range for most decent answers.

            4.0 - 5.9   : Below expectations for mid-level role. Significant omissions, inaccuracies, shallow understanding.

            0.0 - 3.9   : Major problems. Wrong direction, dangerous advice, very superficial or confused.

            Score the answer on a scale of 1-10 based on provided answer and given question and following guidelines: \n
            -Technical accuracy
