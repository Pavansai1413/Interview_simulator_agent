...
graph LR
    ...
    %% Tool block below Analyzer
    B --> T((Resume Parser Tool<br/>PDF/DOCX Parser<br/>))
    T --> B

    B --> C["Interviewer Agent<br/> Generates Adaptive Interview Questions <br/>(based on role, gaps, JD) <br/> Repeat until max_questions reached"]
...
## References
-   [Vertex AI Agent Engine Documentation](https://docs.cloud.google.com/agent-builder/agent-engine/develop/overview?hl=en&_gl=1*uc8j2w*_ga*MTQ4Mjg5MjgxOC4xNzU3MjUxMjg4*_ga_WH2QY8WWF5*czE3NjgxNjE4ODIkbzY5JGcxJHQxNzY4MTYxOTA0JGozOCRsMCRoMA..)
